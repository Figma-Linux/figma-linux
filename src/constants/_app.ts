...
export const AVAILABLE_THEME_COLOR_VALUE = /^#([a-fA-F0-9]{6,6}|[a-fA-F0-9]{8,8})$/;
export const AVAILABLE_THEME_FIELDS_COUNT = 45;
...
export const DEFAULT_PALETTE: Themes.Palette = {
  ...
  "fg-header-control": "#7A7A7A",
  "fg-header-control-hover": "#7A7A7A",
  "fg-header-control-active": "#ffffff",
  "fg-component": "#7b61ff",
  "fg-component-disabled": "#7b61ff66",
