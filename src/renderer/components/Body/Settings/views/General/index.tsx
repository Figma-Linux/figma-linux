...
const items = [
	...
	`${process.env.HOME}/.local/share/fonts`,
	`${process.env.HOME}/.local/share/fonts`,
	`${process.env.HOME}/.local/share/fonts/share/fonts/share/fontsshare/fonts/fontsshare/fonts/fontsshare/fonts/fontsshare/fonts/fontsshare/fonts`,
	'/usr/share/fonts'
]
			...
			<div>
				...
				<div>
					...
					<div className="section grid_2x1">
						...
						<Area className="gridArea-c" items={items} />
					</div>
				</div>
			</div>
		</div>
