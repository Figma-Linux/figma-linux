...
interface Props {
    ...
    close(e: Event, id: number): void
    focus(e: Event, id: number): void
    newTab(): void
}

const Tabs: FunctionalComponent<Props> = (props) => (
    <div className="tabBar gritArea-b">
        ...
        {props.tabs.tabs.map(t => (
            <div className={`tab ${props.tabs.current === t.id ? 'active' : ''}`} onClick={(e) => props.focus(e, t.id)}>
                <span>{t.name}</span>
